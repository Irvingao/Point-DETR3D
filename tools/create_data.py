...
def kitti_data_prep(root_path, info_prefix, version, out_dir):
    ...
    info_train_path = osp.join(root_path, f'{info_prefix}_infos_train_v0173.pkl')
    info_val_path = osp.join(root_path, f'{info_prefix}_infos_val_v0173.pkl')
    info_trainval_path = osp.join(root_path,
                                  f'{info_prefix}_infos_trainval_v0173.pkl')
    info_test_path = osp.join(root_path, f'{info_prefix}_infos_test_v0173.pkl')
    ...
    create_groundtruth_database(
        ...
        root_path,
        info_prefix,
        f'{out_dir}/{info_prefix}_infos_train_v0173.pkl',
        relative_path=False,
        mask_anno_path='instances_train_v0173.json',
