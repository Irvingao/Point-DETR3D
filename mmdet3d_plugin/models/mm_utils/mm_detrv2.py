...
class Point3DMultiModalTransformerV2(BaseModule):
    ...
    def __init__(self, encoder=None, decoder=None, init_cfg=None):
        super(Point3DMultiModalTransformerV2, self).__init__(init_cfg=init_cfg)
...
class Deformable3DMultiModalDetrTransformerDecoderV2(BaseMultiModalTransformerLayerSequence):
    ...
    def __init__(self, *args, return_intermediate=False, **kwargs):
        super(Deformable3DMultiModalDetrTransformerDecoderV2, self).__init__(*args, **kwargs)
    ...
    def forward(self,
        ...
        for lid in range(self.num_layers):
            ...
            if reference_points_2d.shape[-1] == 4:
                reference_points_2d = reference_points_2d[:, :, None] * \
                    torch.cat([valid_ratios, valid_ratios], -1)[:, None]
            else:
                assert reference_points_2d.shape[-1] == 2
                reference_points_2d = reference_points_2d[:, :, None] * \
                    valid_ratios[:, None]
...
@TRANSFORMER.register_module()
class Deformable3DMultiModalDetrTransformerV2(Point3DMultiModalTransformerV2):
    """Implements the DeformableDETR transformer.
    相比较V1, 将reference point更改为3D点生成送入decoder, 和处理
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(Deformable3DMultiModalDetrTransformerV2, self).__init__(**kwargs)
