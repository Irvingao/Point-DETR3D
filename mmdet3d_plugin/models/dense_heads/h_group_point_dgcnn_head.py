...
from ..utils.group_point_encoder import GroupPointEncoder,H_GroupPointEncoder

@HEADS.register_module()
class HGropuPointDGCNN3DHead(DETRHead):
    ...
    def __init__(self,
        ...
        super(HGropuPointDGCNN3DHead, self).__init__(
    ...
    def forward(self, mlvl_feats,point_coord,labels):
        ...
        pointencoder = H_GroupPointEncoder(10, 128,point_coord,labels,self.num_group,self.k_one2many)
