...
from projects.mmdet3d_plugin.models.utils import PointEncoderV2
...
class MMPointDGCNN3DHeadV3(DETRHead):
    ...
    def __init__(self,
        ...
        super(MMPointDGCNN3DHeadV3, self).__init__(
            *args, transformer=transformer, **kwargs)
        
        if self.point_init:
            self.point_embedding_encoder = PointEncoderV2(10, 128)
    ...
    def forward(self, mlvl_pts_feats, mlvl_img_feats, point_coord, labels, img_metas):
        """Forward function.
        Args:
        ...
        # query_embeds = self.point_embedding_encoder.forward(point_coord, labels, self.pc_range)
