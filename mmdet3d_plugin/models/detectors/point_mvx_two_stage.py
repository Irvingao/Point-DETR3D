...
class PointMVXTwoStageDetector(Base3DDetector):
    ...
    def __init__(self,
        ...
        super(PointMVXTwoStageDetector, self).__init__(init_cfg=init_cfg)
    ...
    def simple_test_pts(self, x, img_metas,point_ann,rescale=False):
    ...
    # def generate_pseudo(self,bbox_list):
    #
    #     pts_bbox = bbox_list[0]['pts_bbox']
    #
    #     pass
