...
class Deform3DCamCrossAttnV8(BaseModule):
    """An attention module used in Detr3d. 
        相对于V7，先去除offset，只用reference point复制n份，使用 cam_attention_weights 来对多个cam的output 进行加权
    Args:
    ...
    def __init__(self,
        ...
        super(Deform3DCamCrossAttnV8, self).__init__(init_cfg)
    ...
    def forward(self,
        ...
        # V6: 去除 cam_attention_weights， V8: 重新加上
