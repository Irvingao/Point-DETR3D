...
class Deform3DCamCrossAttnV6(BaseModule):
    """An attention module used in Detr3d. 
        相对于V5，修改cam_attention_weights，去除 cam_attention_weights * output，使其不影响结果
    Args:
    ...
    def __init__(self,
        ...
        super(Deform3DCamCrossAttnV6, self).__init__(init_cfg)
