...
class Deform3DCamCrossAttnV3(BaseModule):
    """An attention module used in Detr3d. 
        相对于原始版本，基于`Deform3DLidarCrossAttn`重构代码，加入cam的cam reference point生成
    Args:
    ...
    def __init__(self,
        ...
        super(Deform3DCamCrossAttnV3, self).__init__(init_cfg)
    ...
    def forward(self,
        ...
        elif reference_points.shape[-1] == 3:   # 3d ref pts and offsets
            offset_normalizer = torch.stack(
        ...
        if torch.cuda.is_available() and value.is_cuda:
            ...
            output = multi_scale_deformable_attn_pytorch(
                value, spatial_shapes, cam_sampling_locations, attention_weights)
