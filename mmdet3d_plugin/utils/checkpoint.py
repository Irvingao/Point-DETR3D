...
def load_submodule_checkpoint(
    ...
    """
    logger.info(f"load pretrained checkpoint from: {filename}")
    ...
    # load state_dict
    logger.info("load pretrained checkpoint for student...")
    load_state_dict(model.student, state_dict, strict, logger)
    logger.info("load pretrained checkpoint for teacher...")
    load_state_dict(model.teacher, state_dict, strict, logger)
    return checkpoint
    # model.student.pts_bbox_head.shared_conv.conv.state_dict()
