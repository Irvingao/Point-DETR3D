_base_ = [
    ...
    '../../../mmdetection3d/configs/_base_/models/centerpoint_01voxel_second_secfpn_nus.py',
...
ann_file=f'/mnt/lustrenew/gaohongzhi/work_dirs/point_objDGCNN/point3d_tec/tec_voxel_base_{rate_str}rate/nuscenes_gt_pseudo_dbinfos_train_{rate_str}rate.pkl'
