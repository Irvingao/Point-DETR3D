...
model = dict(
    ...
    pts_bbox_head=dict(bbox_coder=dict(pc_range=point_cloud_range[:2]),
        obj_contrast=False, 
        feat_contrast=True, 
        loss_feat_contrast=dict(type='ContrastiveNegCosLoss', reduction='mean', loss_weight=0.1),
        point_guide=True,
        point_size_factor=1,
        type='WSCenterHead'),
    loss_type="V5",
...
ann_file=f'/mnt/lustrenew/gaohongzhi/work_dirs/point_objDGCNN/point3d_tec/tec_pillar_ours_{rate_str}rate/nuscenes_gt_pseudo_dbinfos_train_{rate_str}rate.pkl'
