...
class SampledNuScenesDataset(NuScenesDataset):
    r"""NuScenes Dataset.

    This datset only add camera intrinsics and extrinsics to the results.
    """
    def __init__(self, load_ratio=None, load_interval=1, without_vel=False, **kwargs):
        self.load_ratio = load_ratio
        if self.load_ratio:
            assert load_interval == 1
        super(SampledNuScenesDataset,self).__init__(load_interval=load_interval, **kwargs)
