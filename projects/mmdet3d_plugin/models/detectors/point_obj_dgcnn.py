...
from .point_mvx_two_stage import PointMVXTwoStageDetector

@DETECTORS.register_module()
class PointObjDGCNN(PointMVXTwoStageDetector):
    ...
    def forward_pts_train(self,
        ...
        loss_inputs = [gt_bboxes_3d, gt_labels_3d, outs,point_coord,labels]
