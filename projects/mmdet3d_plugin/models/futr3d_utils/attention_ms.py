...
class MSFUTR3DCrossAttn(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 **kwargs):
        super(MSFUTR3DCrossAttn, self).__init__(init_cfg)
        ...
        if self.use_LiDAR:
            ...
            self.pts_value_proj = nn.Linear(embed_dims, embed_dims)
    ...
    def forward(self,
        ...
        if self.use_Cam:
            img_output = self.ms_deformable_attn_img(query, img_feats, \
    ...
    def ms_deformable_attn_img(self, query, img_feats, reference_points, img_metas):
        bs, num_query, _ = query.size()
        value = img_feats
        ...
        lidar2img = []; pc_range = self.pc_range
