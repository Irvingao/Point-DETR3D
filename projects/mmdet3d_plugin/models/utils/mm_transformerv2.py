...
class PointTransformerV2(BaseModule):
    ...
    def __init__(self, encoder_enable=True, encoder=None, decoder=None, init_cfg=None):
        super(PointTransformerV2, self).__init__(init_cfg=init_cfg)
        self.encoder_enable = encoder_enable
        
        self.decoder = build_transformer_layer_sequence(decoder)
        
        if self.encoder_enable and encoder:
...
@TRANSFORMER.register_module()
class MMPointDeformableDetrTransformerV2(PointTransformerV2):
    ...
    def __init__(self,
        ...
        self.img_decoder = build_transformer_layer_sequence(img_decoder)
