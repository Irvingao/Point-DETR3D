...
class PointTransformer(BaseModule):
    ...
    def __init__(self, encoder=None, decoder=None, init_cfg=None):
        super(PointTransformer, self).__init__(init_cfg=init_cfg)
...
@TRANSFORMER.register_module()
class PointDeformableDetrTransformer(PointTransformer):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(PointDeformableDetrTransformer, self).__init__(**kwargs)
